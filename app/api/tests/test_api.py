...
from ..models import DOCUMENT_CLASSIFICATION, SEQUENCE_LABELING, SEQ2SEQ, QANDA
...
class TestUploader(APITestCase):
    ...
    def setUpTestData(cls):
        ...
        cls.qanda_project = mommy.make('QandAProject', users=[super_user], project_type=QANDA)
...
class TestDownloader(APITestCase):
    ...
    def setUpTestData(cls):
        ...
        cls.qanda_url = reverse(viewname='doc_downloader', args=[cls.qanda_project.id])
    ...
    def test_can_download_qanda_jsonl(self):
        self.download_test_helper(url=self.qanda_url,
                                  format='json',
                                  expected_status=status.HTTP_200_OK)
