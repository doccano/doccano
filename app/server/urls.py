...
from .views import ProjectView, DatasetView, DataUpload, LabelView, StatsView, GuidelineView, SettingsView, LabelersView
...
from .api import ProjectViewSet, LabelList, ProjectStatsAPI, LabelDetail, ProjectDetail, \
    AnnotationList, AnnotationDetail, DocumentList, RunModelAPI, LabelersList
...
urlpatterns = [
    ...
    path('api/projects/<int:project_id>/labelers/', LabelersList.as_view(), name='labelers-api'),
