<template>
  <v-card>
    <v-card-title class="mb-2">
      ...
      <document-delete-all-button class="ms-2" />
    </v-card-title>
    <document-list />
  </v-card>
</template>
...
import DocumentDeleteAllButton from '@/components/containers/documents/DocumentDeleteAllButton'
